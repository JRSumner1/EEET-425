...
const unsigned int DATA_LEN = 3600; // 256 512 1200 3600;
...
float IIR_DIRECT(float xv) {
  ...
  static float b[] = {0.1000000,  -0.5000000, 1.0000000,
                      -1.0000000, 0.5000000,  -0.1000000};
  static float a[] = {1.0000000,  -3.8826154, 6.0848146,
                      -4.7635848, 1.8379866,  -0.2708566};
